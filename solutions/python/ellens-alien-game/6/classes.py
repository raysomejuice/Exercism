...
def new_aliens_collection(alien_start_positions: list[tuple[int, int]]) -> list[Alien]:
    """Takes a list of coordinates and instantiates a list of Alien() objects.
    :param alien_start_positions: a list of tuples with two ints - serves 
     as the starting coordinate points for each new alien object instantiated.
