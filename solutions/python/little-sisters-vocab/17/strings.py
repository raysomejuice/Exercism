...
#    new_vocab_words: list[str] = []
    new_vocab_words: list[str] = [vocab_words[0]]

#    for item in range(len(vocab_words)):
#        if item == 0:
#            new_vocab_words.append(vocab_words[item])
#        else:
#            new_vocab_words.append(vocab_words[0] + vocab_words[item])

#    new_vocab_words.append(vocab_words[0])
...
#    new_word = word.removesuffix('ness')
#    return new_word.removesuffix('i') + 'y' if new_word.endswith('i') else new_word
