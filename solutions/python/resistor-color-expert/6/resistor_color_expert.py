...
def resistor_label(colors: list[str]) -> str:
    ...
    if len(colors) == 1:
        if colors[0] == "black":
            ...
            raise ValueError("Single-band resistors are only black in color.")
    ...
    if len(colors) == 5:
        ...
        resistance = _value([first, second, third]) * (10 ** BAND_COLORS[power])
    ...
    return '{:n} {}ohms ±{}%'.format(num, prefix, TOLERANCE_COLORS[tolerance])
